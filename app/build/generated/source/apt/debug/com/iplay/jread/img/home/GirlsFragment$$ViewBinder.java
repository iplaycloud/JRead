...
public class GirlsFragment$$ViewBinder<T extends GirlsFragment> implements ViewBinder<T> {
  ...
  protected static class InnerUnbinder<T extends GirlsFragment> implements Unbinder {
    ...
    protected InnerUnbinder(T target, Finder finder, Object source) {
      ...
      target.mGirlsRecyclerView = finder.findRequiredViewAsType(source, 2131493017, "field 'mGirlsRecyclerView'", EasyRecyclerView.class);
      target.mNetworkErrorLayout = finder.findRequiredViewAsType(source, 2131493016, "field 'mNetworkErrorLayout'", ViewStub.class);
    }

...
public class GirlFragment$$ViewBinder<T extends GirlFragment> implements ViewBinder<T> {
  ...
  protected static class InnerUnbinder<T extends GirlFragment> implements Unbinder {
    ...
    protected InnerUnbinder(T target, Finder finder, Object source) {
      ...
      target.mViewPager = finder.findRequiredViewAsType(source, 2131493014, "field 'mViewPager'", ViewPager.class);
      target.mRootView = finder.findRequiredViewAsType(source, 2131493013, "field 'mRootView'", LinearLayout.class);
    }

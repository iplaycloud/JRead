...
import com.iplay.jread.images.mm.presenter.GirlsPresenter;
import com.iplay.jread.images.mm.widget.detailgirl.GirlActivity;
...
public class GirlsFragment extends BaseFragment implements GirlsContract.View, SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnLoadMoreListener {
    ...
    protected int getLayoutId() {
        return R.layout.img_fragment_home;
    }
    ...
    private void initRecyclerView() {
        ...
        mAdapter.setMore(R.layout.img_load_more_layout, this);
        mAdapter.setNoMore(R.layout.img_no_more_layout);
        mAdapter.setError(R.layout.img_error_layout);
